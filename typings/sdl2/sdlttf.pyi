...
__all__ = ["TTF_Font", "hb_direction_t", "HB_DIRECTION_INVALID", "HB_DIRECTION_LTR", "HB_DIRECTION_RTL", "HB_DIRECTION_TTB", "HB_DIRECTION_BTT", "TTF_Direction", "TTF_DIRECTION_LTR", "TTF_DIRECTION_RTL", "TTF_DIRECTION_TTB", "TTF_DIRECTION_BTT", "SDL_TTF_MAJOR_VERSION", "SDL_TTF_MINOR_VERSION", "SDL_TTF_PATCHLEVEL", "TTF_MAJOR_VERSION", "TTF_MINOR_VERSION", "TTF_PATCHLEVEL", "UNICODE_BOM_NATIVE", "UNICODE_BOM_SWAPPED", "TTF_STYLE_NORMAL", "TTF_STYLE_BOLD", "TTF_STYLE_ITALIC", "TTF_STYLE_UNDERLINE", "TTF_STYLE_STRIKETHROUGH", "TTF_HINTING_NORMAL", "TTF_HINTING_LIGHT", "TTF_HINTING_MONO", "TTF_HINTING_NONE", "TTF_HINTING_LIGHT_SUBPIXEL", "TTF_WRAPPED_ALIGN_LEFT", "TTF_WRAPPED_ALIGN_CENTER", "TTF_WRAPPED_ALIGN_RIGHT", "SDL_TTF_VERSION", "TTF_VERSION", "SDL_TTF_COMPILEDVERSION", "SDL_TTF_VERSION_ATLEAST", "HB_TAG", "TTF_RenderText", "TTF_RenderUTF8", "TTF_RenderUNICODE", "TTF_SetError", "TTF_GetError", "get_dll_file"]
dll = ...
def get_dll_file():
